...
const Blogs: NextPage = (props: any) => {
  return (
    <Fragment>
      <Head>
        <title>Marvin Washington&mdash; Blogs</title>
      </Head>
            ...
            return (
              <div key={blog.slug} className={styles.blogsCardsCard}>
                ...
                <div className={styles.blogsCardsCardContent}>
                  <h3 className={styles.blogsCardsCardContentTitle}>
                    {blog.title}
                  </h3>
                  <p className={styles.blogsCardsCardContentParagraph}>
                    {blog.excerpt}
                  </p>
                  <Link href={'/blogs/' + blog.slug}>
                    <div className={styles.blogsCardsCardContentButton}>
                      READ MORE
                      <BiChevronRight />
                    </div>
                  </Link>
